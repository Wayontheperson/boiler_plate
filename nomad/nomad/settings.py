...
SECRET_KEY = "django-insecure-(t&aoclh(vb&x4j=$p1=@g(!+5fs94-^)unqwh#&qgdq+@_y7a"
...
INSTALLED_APPS = CUSTOM_APP + DJANGO_APP + LIB_APP
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "nomad.authentication.JWTAuthentication",
    ]
}
